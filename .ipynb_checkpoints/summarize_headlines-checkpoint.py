...
def filter_headlines(titles):
    ...
    messages = [
        ...
        {"role": "user", "content": f"Hier is een lijst met krantenkoppen:\n{titles}\nSelecteer alleen de krantenkoppen die relevant zijn voor de Nederlandse commerciële vastgoedmarkt. Geef ook aan bij elke krantenkop vanuit welke site deze kop komt"}
    ]
